...
<table style="width:500px; margin:44px auto" class="table table-striped table-bordered table-hover  table-condensed"
    ...
    <%
        int i = 0;
    %>
    <c:forEach items="${ordersform}" var="ordersform" varStatus="st">
        <tr>
            <td align="center">
                <%=++i%>
            </td>
            <td align="center">${ordersform.loginname}</td>
            <td colspan="3" align="center">${ordersform.goods}</td>
            <td align="center"><a href="/j2ee_war_exploded/DelFromCart?id=${ordersform.id}">删除</a></td>
            <td align="center">${ordersform.sum}</td>
        </tr>
    </c:forEach>
    <tfoot>
    <tr>
        <td colspan="6" align="center">Sum</td>
        <td colspan="1" align="center">${sum}</td>
    </tr>
    </tfoot>
</table>
<nav>
    <ul class="pager">
        ...
        <li><a href="/j2ee_war_exploded/count">结算</a></li>
    </ul>
</nav>
</body>
</html>
